...
const SINGLE_PLAYER_NEXT_MIDDLE : usize = ((TETROMINO_LENGTH + 2) * LENGTH_OF_NEXT_LIST + (LENGTH_OF_NEXT_LIST - 1))*2;
const MULTI_PLAYER_NEXT_MIDDLE : usize = ((TETROMINO_LENGTH + 2) * LENGTH_OF_NEXT_LIST + (LENGTH_OF_NEXT_LIST - 1))*4;
